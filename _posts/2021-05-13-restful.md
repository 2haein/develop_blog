...
description: "REST, REST API, RESTful"
categories: RestAPI
tags:
  - restful
  - restapi
...
- REST의 구체적인 개념
  ...
  - <span style="background-color: red">HTTP URI(Uniform Resource Identifier)를 통해 자원(Resource)을 명시하고, HTTP Method(POST, GET, PUT, DELETE)를 통해 해당 자원에 대한 CRUD Operation</span>
...
- 이러한 멀티 플랫폼에 대한 지원을 위해 서비스 자원에 대한 아키텍처
